...
<body>
  <h3>Alex spends most of his time on...</h3>
  <ul id="activities-list">
    <li class="activity-item">
      <span><span class="icon">📸</span> Taking pictures</span>
      <button class="delete-btn">Delete</button>
    </li>
    <li class="activity-item">
      <span><span class="icon">🚗</span> Going to car meets</span>
      <button class="delete-btn">Delete</button>
    </li>
    <li class="activity-item">
      <span><span class="icon">🏁</span> Attending car shows</span>
      <button class="delete-btn">Delete</button>
    </li>
  </ul>
  ...
  <script>
    ...
    activitiesList.addEventListener("click", (event) => {
      if (event.target.classList.contains("delete-btn")) {
        const li = event.target.closest("li.activity-item");
        if (li) li.remove();
      }
    });
    ...
    addBtn.addEventListener("click", () => {
      ...
      if (newActivity && newActivity.trim() !== "") {
        ...
        span.appendChild(document.createTextNode(" " + newActivity.trim()));
